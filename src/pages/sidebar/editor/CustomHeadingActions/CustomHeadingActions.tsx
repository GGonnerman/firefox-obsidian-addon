...
export default function CustomHeadingActions() {
	...
	return (
		<select
			...
			id="headers"
			value="placeholder"
			className="text-center h-8 bg-transparent hover:bg-blue-400 text-blue-300 font-semibold hover:text-white border border-blue-300 hover:border-transparent rounded px-2 py-1 m-1"
		>
